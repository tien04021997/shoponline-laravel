    ...
    <div class="form-add">
        <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Meta title" value="{{ old('title_seo') }}" name="title_seo">
            </div>

            <div class="form-group">
                <label for="icon">Description seo:</label>
                <input type="text" class="form-control" placeholder="Description seo" value="{{ old('description_seo') }}" name="description_seo">
            </div>
