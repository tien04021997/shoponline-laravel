...
@section('content')
                                    ...
                                    <div class="features-curosel">
                                        <div class="col-lg-12 col-md-12">
                                            ...
                                            <div class="single-product">
                                                ...
                                                <div class="product-img">
                                                    <a href="#">
                                                        <img class="primary-image" src="{{ asset('theme_frontend/img/products/product-3.jpg') }}" alt="" />
                                                        <img class="secondary-image" src="{{ asset('theme_frontend/img/products/product-4.jpg') }}" alt="" />
                                                    </a>
                                                    <div class="action-zoom">
                                                        <div class="add-to-cart">
                                                            <a href="#" title="Quick View"><i class="fa fa-search-plus"></i></a>
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            ...
                                            <div class="single-product">
                                                ...
                                                <div class="product-img">
                                                    <a href="#">
                                                        <img class="primary-image" src="{{ asset('theme_frontend/img/products/product-7.jpg') }}" alt="" />
                                                        <img class="secondary-image" src="{{ asset('theme_frontend/img/products/product-8.jpg') }}" alt="" />
                                                    </a>
                                                    <div class="action-zoom">
                                                        <div class="add-to-cart">
                                                            <a href="#" title="Quick View"><i class="fa fa-search-plus"></i></a>
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            ...
                                            <div class="single-product">
                                                ...
                                                <div class="product-img">
                                                    <a href="#">
                                                        <img class="primary-image" src="{{ asset('theme_frontend/img/products/product-2.jpg') }}" alt="" />
                                                        <img class="secondary-image" src="{{ asset('theme_frontend/img/products/product-3.jpg') }}" alt="" />
                                                    </a>
                                                    <div class="action-zoom">
                                                        <div class="add-to-cart">
                                                            <a href="#" title="Quick View"><i class="fa fa-search-plus"></i></a>
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            ...
                                            <div class="single-product">
                                                ...
                                                <div class="product-img">
                                                    <a href="#">
                                                        <img class="primary-image" src="{{ asset('theme_frontend/img/products/product-6.jpg') }}" alt="" />
                                                        <img class="secondary-image" src="{{ asset('theme_frontend/img/products/product-7.jpg') }}" alt="" />
                                                    </a>
                                                    <div class="action-zoom">
                                                        <div class="add-to-cart">
                                                            <a href="#" title="Quick View"><i class="fa fa-search-plus"></i></a>
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            ...
                                            <div class="single-product">
                                                ...
                                                <div class="product-img">
                                                    <a href="#">
                                                        <img class="primary-image" src="{{ asset('theme_frontend/img/products/product-10.jpg') }}" alt="" />
                                                        <img class="secondary-image" src="{{ asset('theme_frontend/img/products/product-12.jpg') }}" alt="" />
                                                    </a>
                                                    <div class="action-zoom">
                                                        <div class="add-to-cart">
    ...
    <div class="banner-area">
        <div class="container-fluid">
            <div class="row">
                <a href=""><img src="{{ asset('theme_frontend/img/banner/banner-1.jpg') }}" alt="" /></a>
            </div>
        </div>
    </div>
    <!-- banner-area end -->
                ...
                <div class="all-singlepost">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="single-post">
                            <div class="post-thumb">
                                <a href="#">
                                    <img src="{{ asset('theme_frontend/img/post/post-1.jpg') }}" alt="" />
                                </a>
                            </div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="single-post">
                            <div class="post-thumb">
                                <a href="#">
                                    <img src="{{ asset('theme_frontend/img/post/post-2.jpg') }}" alt="" />
                                </a>
                            </div>
                            <div class="post-thumb-info">
                                <div class="post-time">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="single-post">
                            <div class="post-thumb">
                                <a href="#">
                                    <img src="{{ asset('theme_frontend/img/post/post-3.jpg') }}" alt="" />
                                </a>
                            </div>
                            <div class="post-thumb-info">
                                <div class="post-time">
                ...
                <div class="col-md-4">
                    ...
                    <div class="block-carousel">
                        <div class="block-content">
                            ...
                            <div class="single-block">
                                <div class="block-image pull-left">
                                    <a href="product-details.html"><img src="{{ asset('theme_frontend/img/block-cat/block-1.jpg') }}" alt="" /></a>
                                </div>
                            ...
                            <div class="single-block">
                                <div class="block-image pull-left">
                                    <a href="product-details.html"><img src="{{ asset('theme_frontend/img/block-cat/block-2.jpg') }}" alt="" /></a>
                                </div>
                                <div class="category-info">
                        ...
                        <div class="block-content">
                            ...
                            <div class="single-block">
                                <div class="block-image pull-left">
                                    <a href="product-details.html"><img src="{{ asset('theme_frontend/img/block-cat/block-3.jpg') }}" alt="" /></a>
                                </div>
                                <div class="category-info">
                            ...
                            <div class="single-block">
                                <div class="block-image pull-left">
                                    <a href="product-details.html"><img src="{{ asset('theme_frontend/img/block-cat/block-4.jpg') }}" alt="" /></a>
                                </div>
                                <div class="category-info">
                        ...
                        <div class="block-content">
                            ...
                            <div class="single-block">
                                <div class="block-image pull-left">
                                    <a href="product-details.html"><img src="{{ asset('theme_frontend/img/block-cat/block-5.jpg') }}" alt="" /></a>
                                </div>
                                <div class="category-info">
                            ...
                            <div class="single-block">
                                <div class="block-image pull-left">
                                    <a href="product-details.html"><img src="{{ asset('theme_frontend/img/block-cat/block-6.jpg') }}" alt="" /></a>
                                </div>
                                <div class="category-info">
                        ...
                        <div class="block-content">
                            ...
                            <div class="single-block">
                                <div class="block-image pull-left">
                                    <a href="product-details.html"><img src="{{ asset('theme_frontend/img/block-cat/block-9.jpg') }}" alt="" /></a>
                                </div>
                                <div class="category-info">
                ...
                <div class="col-md-4">
                    ...
                    <div class="block-carousel">
                        <div class="block-content">
                            ...
                            <div class="single-block">
                                <div class="block-image pull-left">
                                    <a href="product-details.html"><img src="{{ asset('theme_frontend/img/block-cat/block-10.jpg') }}" alt="" /></a>
                                </div>
                                <div class="category-info">
                                    <h3><a href="product-details.html">Cras neque metus</a></h3>
                                    <p>Nunc facilisis sagittis ullamcorper...</p>
                        ...
                        <div class="block-content">
                            ...
                            <div class="single-block">
                                <div class="block-image pull-left">
                                    <a href="product-details.html"><img src="{{ asset('theme_frontend/img/block-cat/block-7.jpg') }}" alt="" /></a>
                                </div>
                                <div class="category-info">
                                    <h3><a href="product-details.html">Donec ac tempus</a></h3>
                                    <p>Nunc facilisis sagittis ullamcorper...</p>
                            ...
                            <div class="single-block">
                                <div class="block-image pull-left">
                                    <a href="product-details.html"><img src="{{ asset('theme_frontend/img/block-cat/block-8.jpg') }}" alt="" /></a>
                                </div>
                                <div class="category-info">
                                    <h3><a href="product-details.html">Primis in faucibus</a></h3>
                                    <p>Nunc facilisis sagittis ullamcorper...</p>
                        ...
                        <div class="block-content">
                            ...
                            <div class="single-block">
                                <div class="block-image pull-left">
                                    <a href="product-details.html"><img src="{{ asset('theme_frontend/img/block-cat/block-11.jpg') }}" alt="" /></a>
                                </div>
                                <div class="category-info">
                                    <h3><a href="product-details.html">Occaecati cupiditate</a></h3>
                                    <p>Nunc facilisis sagittis ullamcorper...</p>
                            ...
                            <div class="single-block">
                                <div class="block-image pull-left">
                                    <a href="product-details.html"><img src="{{ asset('theme_frontend/img/block-cat/block-12.jpg') }}" alt="" /></a>
                                </div>
                                <div class="category-info">
                                    <h3><a href="product-details.html">Accumsan elit</a></h3>
                                    <p>Nunc facilisis sagittis ullamcorper...</p>
                        ...
                        <div class="block-content">
                            ...
                            <div class="single-block">
                                <div class="block-image pull-left">
                                    <a href="product-details.html"><img src="{{ asset('theme_frontend/img/block-cat/block-13.jpg') }}" alt="" /></a>
                                </div>
                                <div class="category-info">
                                    <h3><a href="product-details.html">Pellentesque habitant</a></h3>
                                    <p>Nunc facilisis sagittis ullamcorper...</p>
                            ...
                            <div class="single-block">
                                <div class="block-image pull-left">
                                    <a href="product-details.html"><img src="{{ asset('theme_frontend/img/block-cat/block-14.jpg') }}" alt="" /></a>
                                </div>
                                <div class="category-info">
                                    <h3><a href="product-details.html">Donec non est</a></h3>
                                    <p>Nunc facilisis sagittis ullamcorper...</p>
